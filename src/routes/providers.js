...
const { scrapeProviders, scrapeProvidersPersonsImages } = require('../controllers/providers');
...
//  logger.debug('finished scrapeProviders');
  await scrapeProvidersPersonsImages(req);
logger.debug('finished scrapeProvidersPersonsImages');
});
